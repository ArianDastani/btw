...
function(r, s) {
    ...
    r.Demo = {
            ...
            apply: function() {
                ...
                for (var e = 0, t = i; e < t.length; e++) {
                    ...
                    "aside" !== n && "header" !== n && "style" !== n || (o = r.Demo.defs(n),
                            s(a = "aside" === n ? u : "header" === n ? c : d).removeClass(r.Demo.style("all", n)),
            ...
            update: function(e, t, o) {
                var a, n = r.Demo.style(t, e),
                    i = r.Demo.style("all", e);
                r.Demo.apps();
                "aside" !== e && "header" !== e || (s(a = "header" == e ? c : u).removeClass(i),
                        s(a).addClass(n)),
                    ...
                    "skin" === e && (a = r.Demo.skins(n),
                        ...
                        "theme" === a ? s(m).remove() : 0 < s(m).length ? s(m).attr("href", i) : l.append('<link id="skin-theme" rel="stylesheet" href="' + i + '">')), !0 === o && r.Demo.save(e, t)
            },
            reset: function() {
                var t = r.Demo.apps();
                ...
                for (var e = 0, o = i; e < o.length; e++) {
                    ...
                    s("[data-key='" + a + "']").each(function() {
                            ...
                            "aside" !== a && "header" !== a && "style" !== a || e === y[t][a] && s(this).addClass("active"),
